    ...
    return (
      <div className="category-tabs">
        <Tabs
          ...
          ripple
        >
          <Tab>Project-1 IdeaLab</Tab>
          <Tab>Project 2 - Hackathon Finder</Tab>
          <Tab>Project 3 - Find Surf Spot App</Tab>
        </Tabs>
