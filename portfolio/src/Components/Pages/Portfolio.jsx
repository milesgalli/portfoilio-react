  ...
  toggleCategories() {
    ...
    if (this.state.activeTab === 0) {
      ...
      return (
        ...
        >
          Project 2 - Hackathon Finder
        </CardTitle>

        <CardText>
        A platfrom that connects graduates with businesses. On the platform companies post software related issues specific to there business, students can view these problems and develop solutions to sovle them. 
        <br/>
        <br/>
        The idea being that users can collaborate with other students on the platfrom. The benefit to students being that they get the chance to develop new skills, solve real world problems, network and have additional projects to add to their porfolio or resume.
        </CardText>
   ...
   <Card shadow={0} style={{ width: "450px", margin: "auto" }}>
        ...
        >
          Project 1 - Find Surf App
        </CardTitle>

        <CardText>
        Forecast Websites are difficult to interpret and read. It is difficult to know where the best place to surf will be, based on the conditions and a person's surfing ability.
        <br/>
        <br/>
